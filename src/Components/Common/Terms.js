    ...
    return (
      <div className="lg:mx-[13%] lg:my-8 mx-[2%] my-[1%]">
        ...
        <p className="mb-4">
          ...
          shall be considered as implied acceptance and agreement to the Terms and
          Conditions listed below. Should you find some of the Terms and
          Conditions outlined in this section to your liking or agreeable, please
          refrain from continuing to use the Website.
        </p>
        ...
        <p className="lg:mb-10 mb-5 text-justify">
          <strong>Related Materials:</strong> The materials include all copyright,
          trademark, and other applicable provisions. You agree not to use,
          reproduce, copy, distribute, or create any derivative works of any of
          the content herein without obtaining our prior written permission.
        </p>
        ...
        <div className="lg:ml-5">
          ...
          <p className="lg:mb-10 mb-5 text-justify">
            ...
            otherwise objectionable, and does not otherwise violate our terms and
            conditions.
          </p>
        </div>
        ...
        <p className="lg:mb-10 mb-5 text-justify">
          ...
          Third-party sites and their content, privacy, policy, and practices are
          outside of Homimprovement's control.
        </p>
        ...
        <p className="lg:mb-10 mb-5 text-justify">
          ...
          controlled or under direct or indirect control of Homimprovement hereby
          disclaim any and all forms of liability to users for any direct,
          indirect, incidental, consequential or special damages arising out of or
          in relation to the use of the Website or any service incorporated with
          this Website.
        </p>
        <p className="lg:mb-10 mb-5 text-justify">
          This disclaimer shall be to the fullest extent permitted by law. All
          these entailed but were not limited to loss of data, money, or business
          opportunities.
        </p>
        ...
        <p className="lg:mb-10 mb-5 text-justify">
          ...
          from and against any claim that comes up because of how you use the
          Website, break these Terms, or violate someone else's rights.
        </p>
        ...
        <p className="lg:mb-10 mb-5 text-justify">
          We think your privacy matters and we want to make it secure. You can see
          details on how we collect, use, and protect your data in our Privacy
          Policy. By using our site, you accept our Privacy Policy each time you
          come.
        </p>
        ...
        <p className="lg:mb-10 mb-5 text-justify">
          ...
          these Terms at any time and for any reason, without warning. That's your
          decision entirely. When the new version is posted on the website, the
          change will apply right away.
        </p>
        <p className="lg:mb-10 mb-5 text-justify">
        ...
        <p className="lg:mb-10 mb-5 text-justify">
          You can contact us anytime with questions or concerns about these Terms
          and Conditions.
        </p>
        <p className="lg:mb-10 mb-5 text-justify">
